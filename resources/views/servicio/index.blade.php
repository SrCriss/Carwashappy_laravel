        ...
        <div class="container-xl">
            <div class="row g-2 align-items-center">
                ...
                <div class="col-12 col-md-auto ms-auto d-print-none">
                    <div class="btn-list">
                        <a href="{{ route('servicios.create') }}" class="btn btn-primary d-none d-sm-inline-block">
                ...
                <div class="col-12">
                    <div class="card">
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        ...
                                                        <form
                                                            ...
                                                            @method('DELETE')
                                                            <button type="submit"
                                                                    onclick="if(!confirm('¿Te gustaria Eliminar este registro?')){return false;}"
                       ...
                       <div class="card-footer d-flex align-items-center">
                        <!-- Aqui se renderiza la paginación debido a que devuelve un objeto paginable -->
